...
encsrcdir = ./enc
topdir = .
prefix = /Users/matthewphilips/src/ruby-3.2.2
exec_prefix = $(prefix)
libdir = /Users/matthewphilips/src/ruby-3.2.2
...
DEFS = 
CPPFLAGS = -I/usr/local/opt/openssl@1.1/include -I/usr/local/opt/readline/include -I/usr/local/opt/libyaml/include -I/usr/local/opt/gdbm/include -D_XOPEN_SOURCE -D_DARWIN_C_SOURCE -D_DARWIN_UNLIMITED_SELECT -D_REENTRANT $(DEFS) $(cppflags) -DONIG_ENC_REGISTER=rb_enc_register
LDFLAGS = -L. -fstack-protector-strong -L/usr/local/opt/openssl@1.1/lib -L/usr/local/opt/readline/lib -L/usr/local/opt/libyaml/lib -L/usr/local/opt/gdbm/lib
LDSHARED = $(CC) -dynamic -bundle
ldflags  = $(LDFLAGS)
dldflags = -L/usr/local/opt/openssl@1.1/lib -L/usr/local/opt/readline/lib -L/usr/local/opt/libyaml/lib -L/usr/local/opt/gdbm/lib -Wl,-multiply_defined,suppress
